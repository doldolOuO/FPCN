...
DATA_DIR = 'F:\\3D\\点云补全代码复现\\data'
dataset_path=os.path.abspath(os.path.join(DATA_DIR, 'shapenetcore_partanno_segmentation_benchmark_v0/'))
...
class PartDataset(data.Dataset):
    def __init__(self, root=dataset_path, npoints=2500, classification=False, class_choice=None, split='train', normalize=True):
        ...
        self.root = os.path.join(root, 'shapenetcore_partanno_segmentation_benchmark_v0/')
...
if __name__ == '__main__':
    ...
    dset = PartDataset( root=DATA_DIR, classification=True, class_choice=None, npoints=4096, split='train')
