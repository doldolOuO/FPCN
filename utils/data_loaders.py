...
class Dataset(torch.utils.data.dataset.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for ri in self.options['required_items']:
            ...
            # if ri == 'gtcloud':
            #     choice1 = random.sample(range(0,16384), 512)  
            #     data['stage1'] = data[ri][choice1]
                # choice3 = random.sample(range(0,16384), 2048)  
                # data['stage3'] = data[ri][choice3]
                # choice2 = random.sample(range(0,2048), 512) 
                # data['stage1'] = data['gtcloud'][choice2]
                # choice1 = random.sample(range(0,1024), 512)
                # data['stage1'] = data['stage2'][choice1]

                #data['coarse_cloud'] = data[ri][choice]
...
class ShapeNetDataLoader(object):
    ...
    def get_dataset(self, subset):
        ...
        }, file_list, transforms=transforms)
...
if __name__ == '__main__':
    ...
    dataset_loader = DATASET_LOADER_MAPPING[cfg.DATASET.TRAIN_DATASET](cfg)